...
const TicketCard = ({ ticket, handleTaskStatus }) => {
    ...
    <div className="flex justify-between xl:flex-row flex-col-reverse  items-start gap-4">
        <h3 className="text-lg font-medium text-start tracking-tight text-gray-900 leading-snug">{title}</h3>
    ...
    <div className="mt-auto pt-3 flex items-center flex-wrap justify-between text-sm text-gray-400">
